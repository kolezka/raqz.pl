    ...
    <div className="bg-white">
      <div className="mx-auto max-w-4xl px-6 py-16 lg:px-8 lg:py-24">
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-500">Last updated: December 8, 2024</p>
        </div>
        ...
        <div className="prose prose-gray max-w-none">
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-1">
                  ...
                  <li>
                    <code className="text-sm bg-gray-100 px-1.5 py-0.5 rounded">NEXT_LOCALE</code> -
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-1">
                  <li>
                    ...
                    <code className="text-sm bg-gray-100 px-1.5 py-0.5 rounded">_ga</code>,{' '}
                    <code className="text-sm bg-gray-100 px-1.5 py-0.5 rounded">_gid</code>, and{' '}
                    <code className="text-sm bg-gray-100 px-1.5 py-0.5 rounded">_ga_*</code>
                  </li>
                  <li>
          ...
          <section className="mb-12">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <p className="text-gray-900 font-semibold mb-2">raqz.pl</p>
              <p className="text-gray-600 mb-1">Mikołajki, Mazury, Polska</p>
              <p className="text-gray-600">
                Email:{' '}
                <a
    ...
    <div className="bg-white">
      <div className="mx-auto max-w-4xl px-6 py-16 lg:px-8 lg:py-24">
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-500">Ostatnia aktualizacja: 8 grudnia 2024</p>
        </div>
        ...
        <div className="prose prose-gray max-w-none">
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-1">
                  <li>
                    ...
                    <code className="text-sm bg-gray-100 px-1.5 py-0.5 rounded">_ga</code>,{' '}
                    <code className="text-sm bg-gray-100 px-1.5 py-0.5 rounded">_gid</code> oraz{' '}
                    <code className="text-sm bg-gray-100 px-1.5 py-0.5 rounded">_ga_*</code>
                  </li>
                  <li>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 mb-4">Zebrane informacje wykorzystujemy do:</p>
            <ul className="list-disc list-inside text-gray-600 space-y-2">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">7. Usługi stron trzecich</h2>
            <p className="text-gray-600 mb-4">
          ...
          {/* 8. Prywatność dzieci */}
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">8. Prywatność dzieci</h2>
            <p className="text-gray-600">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">10. Informacje kontaktowe</h2>
            <p className="text-gray-600 mb-4">
