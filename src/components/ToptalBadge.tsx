...
export default function ToptalBadge() {
  return (
    <div className="flex my-8 md:mb-0">
      <div className="relative inline-block">
        ...
        <div className="toptal-hexagon">
          <div className="toptal-badge">
            ...
            <div className="toptal-divider" />
            <span className="toptal-vetted">Vetted by</span>
            ...
            <a
              className="toptal-link"
              href="https://www.toptal.com/developers/resume/mariusz-rakus#4Ldamd"
              target="_blank"
