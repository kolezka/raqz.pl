...
export default memo(function ServicesDropdown() {
  ...
  return (
    <Popover className="relative inline-block text-left">
      <PopoverButton className="inline-flex w-full justify-center items-center text-sm font-semibold leading-6 transition-colors duration-300 text-gray-900 hover:text-gray-600 focus:outline-none">
      ...
      <PopoverPanel
        transition
        className="fixed left-1/2 top-[5rem] -translate-x-1/2 z-50 max-w-4xl w-[min(100vw-2rem,64rem)] max-h-[80vh] rounded-xl bg-white/90 backdrop-blur-xl shadow-2xl ring-1 ring-gray-200/50 border border-gray-100/50 focus:outline-none overflow-y-auto overflow-x-hidden transition ease-out duration-200 data-closed:transform data-closed:opacity-0 data-closed:scale-95 data-closed:translate-y-[-16px]"
      >
