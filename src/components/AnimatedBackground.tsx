...
export default memo(function AnimatedBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      <div
        className="absolute top-1/3 left-1/3 w-20 h-20 opacity-30 rounded-full bg-gradient-to-r from-purple-400 to-pink-400 animate-pulse-slow"
        style={{ filter: 'blur(10px)' }}
      />

      <div
        className="absolute bottom-1/3 right-1/4 w-16 h-16 opacity-35 rounded-full bg-gradient-to-r from-green-400 to-blue-400 animate-float-reverse"
